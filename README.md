## nmea_gps_plugin (kinetic) - 0.0.2-2

The packages in the `nmea_gps_plugin` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic nmea_gps_plugin` on `Wed, 18 Sep 2019 01:09:41 -0000`
...
## nmea_gps_plugin (melodic) - 0.0.2-1

The packages in the `nmea_gps_plugin` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic nmea_gps_plugin` on `Sat, 13 Jul 2019 09:04:49 -0000`
...
## nmea_gps_plugin (kinetic) - 0.0.2-1

The packages in the `nmea_gps_plugin` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic nmea_gps_plugin` on `Sat, 13 Jul 2019 08:58:35 -0000`
...
## nmea_gps_plugin (melodic) - 0.0.1-4

The packages in the `nmea_gps_plugin` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic nmea_gps_plugin` on `Sun, 30 Jun 2019 02:33:39 -0000`
...
## nmea_gps_plugin (kinetic) - 0.0.1-2

The packages in the `nmea_gps_plugin` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic nmea_gps_plugin` on `Sun, 30 Jun 2019 02:29:14 -0000`
...
## nmea_gps_plugin (kinetic) - 0.0.1-1
